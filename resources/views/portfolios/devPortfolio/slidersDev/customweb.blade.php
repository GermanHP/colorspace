    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="carousel2"
                ...
                <img src="img/porta/dev/customwebs/2.jpg" alt="web" />
                ...
                <img src="img/porta/dev/customwebs/9.jpg" alt="web" />
                <img src="img/porta/dev/customwebs/10.jpg" alt="web" />
                <img src="img/porta/dev/customwebs/11.jpg" alt="web" />
                <img src="img/porta/dev/customwebs/12.jpg" alt="web" />
                <img src="img/porta/dev/customwebs/13.jpg" alt="web" />
            </div>
        </div>
