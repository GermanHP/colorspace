...
@include('includes.slidersArqui')
        <div class="row">
            <div class="col-md-4">
                ...
                <h5 id="arquitectura" class="text-center white-text interlineado"><span>Supervición - Construcción</span></h5><br>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <h5 id="arquitectura" class="text-center white-text interlineado"><span>Diseño Arquitectónico x Supervición x Construcción</span></h5><br>
            </div>
            <div class="col-md-4">
                ...
                <h5 id="arquitectura" class="text-center white-text interlineado"><span>Diseño Arquitectónico</span></h5><br>
            </div>
            <div class="col-md-4">
